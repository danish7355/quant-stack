      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-[#161B22] rounded-xl p-6 border border-[#30363D] space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            >
              <div className="font-bold text-sm">Macro Accumulation Box</div>
              <div className="text-[11px] opacity-80 leading-relaxed">Massive 150-candle Wyckoff accumulation breakouts</div>
            </button>
            ...
            >
              <div className="font-bold text-sm">Early Coil Breakout</div>
              <div className="text-[11px] opacity-80 leading-relaxed">Fractal pivot pre-confirmation breakout strategy</div>
            </button>
            ...
            >
              ...
              <div className="text-[11px] opacity-80 leading-relaxed">
                Detects early reversals after a liquidity sweep / climax. Waits for sweep, CHoCH, and FVG retest.
              </div>
            </button>
